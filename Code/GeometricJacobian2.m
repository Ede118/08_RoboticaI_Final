...
clc; clear; close all; % Buena práctica para limpiar el entorno

my_robot; % Carga los parámetros DH y el objeto Robot
% Robot.display; % Opcional, puedes descomentarlo si necesitas verlo
...
% Agregar 'real' es CRUCIAL para que MATLAB simplifique bien la trigonometría
...
% Factorizamos el determinante (Extrae los paréntesis y factores comunes)
vector_factores = factor(detAJ11);

% Multiplicamos los factores de vuelta y forzamos una simplificación profunda
