...
R = 0.4;                    % Radio del cilindro (reducido para no saturar el WorkSpace)
...
Cx = 1.3; % El cilindro está 130 cm frente al robot en el eje X
...
% 1. Suavizamos la Geometría (Mata el vértice de 90° creando un arco)
...
% 2. Suavizamos la Orientación (Hace que la muñeca gire progresivamente)
