...
% ¡WARNING! q5 = pi/2 para que sin(q5) ~= 0 y evitar la singularidad de muñeca.
q1 = 0; 
q4 = 0; 
q5 = pi/2;
q6 = 0;
...
for i = 1:size(puntos_prueba, 1)
    % 1. Valor del gráfico (matemático) en radianes
    q2_math = deg2rad(puntos_prueba(i, 1)); 
    q3_math = deg2rad(puntos_prueba(i, 2));

    % 2. Resta de offset real del robot
    ...
    % 4. Jacobiano respecto a la base
